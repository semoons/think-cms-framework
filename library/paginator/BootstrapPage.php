...
class BootstrapPage extends Paginator
{
     ...
     */
    public function render($total_count=null)
    {
        if ($this->hasPages()) {
    ...
    protected function getDisabledTextWrapper($text)
    {
        ...
        return '<li class="disabled"><a href="#">' . $text . ' <span class="sr-only">(current)</span></a></li>';
    }
    ...
    {
        return '<li class="active"><a href="#">' . $text . ' <span class="sr-only">(current)</span></a></li>';
    }
